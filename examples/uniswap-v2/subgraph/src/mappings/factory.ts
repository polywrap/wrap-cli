...
import { UniswapFactory, Pair, Token, Bundle } from '../codegen/schema'
import { PairCreated } from '../codegen/Factory/Factory'
import { Pair as PairTemplate } from '../codegen/templates'
import {
  FACTORY_ADDRESS,
  ZERO_BD,
  ZERO_BI,
