...
impl Write for WriteSizer {
    ...
    fn write_i64<W: IoWrite>(&mut self, _writer: &mut W, _value: i64) -> Result<(), EncodingError> {
        unimplemented!()
    }
    ...
    fn write_u64<W: IoWrite>(&mut self, _writer: &mut W, _value: u64) -> Result<(), EncodingError> {
        unimplemented!()
    }
