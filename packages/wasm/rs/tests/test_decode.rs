...
fn test_read_f64() {
	let mut reader =
		ReadDecoder::new(&[0xcb, 0x7f, 0xf0, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00], Context::new());
...
fn test_read_i64() {
	let mut reader =
		ReadDecoder::new(&[0xd3, 0x80, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00], Context::new());
...
fn test_read_u64() {
	let mut reader =
		ReadDecoder::new(&[0xcf, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff], Context::new());
