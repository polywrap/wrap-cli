...
export abstract class Read {
  ...
  abstract readMap<K, V>(key_fn: (reader: Read) => K, value_fn: (reader: Read) => V): Map<K, V>;
  ...
  abstract readNullableMap<K, V>(key_fn: (reader: Read) => K, value_fn: (reader: Read) => V): Map<K, V> | null;
}
