...
# [ ] test_maybeasync_can_handle_several_coroutines asyncio.gather(*tasks)
...
# [ ] test_maybeasync_executes_asynchronous_generator might be a good idea to test
...
async def test_maybeasync_asyncs_awaits_and_executes_coroutines_correctly(awaitable_function):
    """ 
    The MaybeAsync module should receive a coroutine as input, along with its positional arguments if it has any
