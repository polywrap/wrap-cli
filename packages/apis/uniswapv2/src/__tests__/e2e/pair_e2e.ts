  ...
  describe('Pair', async () => {
    ...
    describe('miscellaneous', () => {
      it('getLiquidityMinted:0', async () => {
        const tokenA = { chainId: ChainId.RINKEBY, address: '0x0000000000000000000000000000000000000001', decimals: 18 };
        const tokenB = { chainId: ChainId.RINKEBY, address: '0x0000000000000000000000000000000000000002', decimals: 18 };
