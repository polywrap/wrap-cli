...
export class Ethereum_TxRequest {
  ...
  static toJson(type: Ethereum_TxRequest): JSON.Value {
    return JSONSerializer.encode(type);
  }

  static fromJson(json: JSON.Value): Ethereum_TxRequest {
    return (new JSONDeserializer(json)).decode<Ethereum_TxRequest>();
  }
}
