...
pub struct InputImportedMethod {
    ...
    pub opt_object: Option<Box<TestImportObject>>,
    pub object_array: Vec<Box<TestImportObject>>,
    pub opt_object_array: Option<Vec<Option<Box<TestImportObject>>>>,
...
pub fn write_imported_method_args<W: Write>(input: &InputImportedMethod, writer: &mut W) {
    ...
    writer
        .context()
        .push("object", "Box<TestImportObject>", "writing property");
    writer.write_str("object");
    TestImportObject::write(&input.object, writer);
    writer.context().pop();
    writer.context().push(
        "opt_object",
        "Option<Box<TestImportObject>>",
        "writing property",
    );
    ...
    writer.context().push(
        "opt_object_array",
        "Option<Vec<Option<Box<TestImportObject>>>>",
        "writing property",
    );
