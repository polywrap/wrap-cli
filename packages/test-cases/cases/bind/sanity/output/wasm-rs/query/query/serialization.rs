use crate::{
    get_custom_enum_value, sanitize_custom_enum_value, AnotherType, Context, CustomEnum, Read,
    ReadDecoder, Write, WriteEncoder, WriteSizer,
};
        ...
        match field.as_str() {
            "string" => {
                ...
                reader
                    .context()
                    .pop()
                    .expect("Failed to pop value from Context");
            }
            "opt_string" => {
                reader
                    .context()
