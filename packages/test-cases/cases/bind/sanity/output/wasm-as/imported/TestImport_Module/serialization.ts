...
export function writeimportedMethodArgs(
  ...
  writer.writeNullableString(args.optStr);
  writer.context().pop();
  ...
  writer.writeNullableUInt32(args.optU);
  writer.context().pop();
  ...
  writer.writeNullableArray(args.optObjectArray, (writer: Write, item: Types.TestImport_Object | null): void => {
    if (item) {
  ...
  writer.writeNullableInt32(args.optEnum);
  writer.context().pop();
  ...
  writer.writeNullableArray(args.optEnumArray, (writer: Write, item: Option<Types.TestImport_Enum>): void => {
