...
export class Args_importedMethod {
  ...
  uArrayArray: Array<Array<Nullable<u32> | null> | null>;
...
export function writeimportedMethodArgs(
  ...
  writer.context().pop();
  writer.context().push("uArrayArray", "Array<Array<Nullable<u32> | null> | null>", "writing property");
  writer.writeString("uArrayArray");
  writer.writeArray(args.uArrayArray, (writer: Write, item: Array<Nullable<u32> | null> | null): void => {
  ...
  writer.writeOptionalArray(args.optEnumArray, (writer: Write, item: Nullable<Types.TestImport_Enum> | null): void => {
