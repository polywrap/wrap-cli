...
export function serializeTestImport_Object(
  type: TestImport_Object
): ArrayBuffer {
  const sizerContext: Context = new Context(
    "Serializing (sizing)  imported object-type: TestImport_Object"
  );
  const sizer = new WriteSizer(sizerContext);
  writeTestImport_Object(sizer, type);
  const buffer = new ArrayBuffer(sizer.length);
  const encoderContext: Context = new Context(
    "Serializing (encoding) import object-type: TestImport_Object"
  );
...
export function writeTestImport_Object(
  writer: Write,
  type: TestImport_Object
): void {
  ...
  writer
    .context()
    .push("object", "Types.TestImport_AnotherObject", "writing property");
  ...
  writer
    ...
    .push(
      "optObject",
      "Types.TestImport_AnotherObject | null",
      "writing property"
    );
  writer.writeString("optObject");
  if (type.optObject) {
    Types.TestImport_AnotherObject.write(
      writer,
      type.optObject as Types.TestImport_AnotherObject
    );
  } else {
    writer.writeNil();
  }
  ...
  writer
    ...
    .push(
      "objectArray",
      "Array<Types.TestImport_AnotherObject>",
      "writing property"
    );
  writer.writeString("objectArray");
  writer.writeArray(
    type.objectArray,
    (writer: Write, item: Types.TestImport_AnotherObject): void => {
  ...
  writer
    ...
    .push(
      "optObjectArray",
      "Array<Types.TestImport_AnotherObject | null> | null",
      "writing property"
    );
  writer.writeString("optObjectArray");
  writer.writeNullableArray(
    type.optObjectArray,
    (writer: Write, item: Types.TestImport_AnotherObject | null): void => {
      if (item) {
        Types.TestImport_AnotherObject.write(
          writer,
          item as Types.TestImport_AnotherObject
        );
      } else {
        writer.writeNil();
      }
  ...
  writer
    .context()
    .push("optEnum", "Nullable<Types.TestImport_Enum>", "writing property");
  writer.writeString("optEnum");
  writer.writeNullableInt32(type.optEnum);
  writer.context().pop();
  writer
    .context()
    .push("enumArray", "Array<Types.TestImport_Enum>", "writing property");
  writer.writeString("enumArray");
  writer.writeArray(
    type.enumArray,
    (writer: Write, item: Types.TestImport_Enum): void => {
  ...
  writer
    ...
    .push(
      "optEnumArray",
      "Array<Nullable<Types.TestImport_Enum>> | null",
      "writing property"
    );
  writer.writeString("optEnumArray");
  writer.writeNullableArray(
    type.optEnumArray,
    (writer: Write, item: Nullable<Types.TestImport_Enum>): void => {
...
export function deserializeTestImport_Object(
  buffer: ArrayBuffer
): TestImport_Object {
  const context: Context = new Context(
    "Deserializing imported object-type TestImport_Object"
  );
...
export function readTestImport_Object(reader: Read): TestImport_Object {
  ...
  while (numFields > 0) {
    ...
    if (field == "object") {
      reader
        ...
        .push(
          field,
          "Types.TestImport_AnotherObject",
      ...
      _objectArray = reader.readArray(
        (reader: Read): Types.TestImport_AnotherObject => {
          const object = Types.TestImport_AnotherObject.read(reader);
          return object;
        }
      );
      ...
      _optObjectArray = reader.readNullableArray(
        (reader: Read): Types.TestImport_AnotherObject | null => {
          let object: Types.TestImport_AnotherObject | null = null;
          if (!reader.isNextNil()) {
            object = Types.TestImport_AnotherObject.read(reader);
          }
      ...
      reader
        .context()
        .push(field, "Types.TestImport_Enum", "type found, reading property");
      ...
      reader
        ...
        .push(
          field,
          "Nullable<Types.TestImport_Enum>",
          "type found, reading property"
        );
      ...
      reader
        ...
        .push(
          field,
          "Array<Types.TestImport_Enum>",
          "type found, reading property"
        );
      _enumArray = reader.readArray(
        (reader: Read): Types.TestImport_Enum => {
          let value: Types.TestImport_Enum;
          if (reader.isNextString()) {
            value = Types.getTestImport_EnumValue(reader.readString());
          } else {
      ...
      _optEnumArray = reader.readNullableArray(
        (reader: Read): Nullable<Types.TestImport_Enum> => {
          let value: Nullable<Types.TestImport_Enum>;
          if (!reader.isNextNil()) {
            if (reader.isNextString()) {
              value = Nullable.fromValue(
  ...
  if (!_object || !_objectSet) {
    throw new Error(
      reader
        .context()
        .printWithContext(
          "Missing required property: 'object: TestImport_AnotherObject'"
        )
    );
  }
  if (!_objectArraySet) {
  ...
  if (!_enSet) {
    throw new Error(
      reader
        .context()
        .printWithContext("Missing required property: 'en: TestImport_Enum'")
    );
  }
  if (!_enumArraySet) {
    throw new Error(
      reader
        .context()
        .printWithContext(
          "Missing required property: 'enumArray: [TestImport_Enum]'"
        )
    );
  }
