...
export class Ethereum_TxResponse {
  ...
  static toJson(type: Ethereum_TxResponse): JSON.Value {
    return JSONSerializer.encode(type);
  }

  static fromJson(json: JSON.Value): Ethereum_TxResponse {
    return (new JSONDeserializer(json)).decode<Ethereum_TxResponse>();
  }
}
