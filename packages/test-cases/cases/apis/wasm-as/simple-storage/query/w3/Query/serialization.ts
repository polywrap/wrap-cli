...
export class Input_tryGetData {
  address: string;
  connection: Types.Ethereum_Connection | null;
}

export function deserializetryGetDataArgs(argsBuf: ArrayBuffer): Input_tryGetData {
...
export class Input_throwGetData {
  address: string;
  connection: Types.Ethereum_Connection | null;
}

export function deserializethrowGetDataArgs(argsBuf: ArrayBuffer): Input_throwGetData {
