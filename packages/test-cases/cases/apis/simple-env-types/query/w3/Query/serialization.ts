...
export function serializegetEnvResult(result: Types.QueryEnv): ArrayBuffer {
...
export function writegetEnvResult(writer: Write, result: Types.QueryEnv): void {
  writer.context().push("getEnv", "Types.QueryEnv", "writing property");
