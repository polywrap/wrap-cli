...
export class Ethereum_StaticTxResult {
  ...
  static toJson(type: Ethereum_StaticTxResult): JSON.Value {
    return JSONSerializer.encode(type);
  }

  static fromJson(json: JSON.Value): Ethereum_StaticTxResult {
    return (new JSONDeserializer(json)).decode<Ethereum_StaticTxResult>();
  }
}
