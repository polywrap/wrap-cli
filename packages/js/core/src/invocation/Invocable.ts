...
export interface Invocable {
  /**
   * Execute the invocation based on the provided [[InvokeOptions]]
   *
   * @param options Options for this invocation.
   * @param invoker The invoker requesting this invocation.
   * This will be used for any sub-invocations that occur.
   */
  invoke(
