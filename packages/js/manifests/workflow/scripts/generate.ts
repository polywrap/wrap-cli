...
async function generateFormatTypes() {
  // Fetch all schemas within the @polywrap/workflowmanifest-schemas/schemas/formats directory
  const schemasPackageDir = path.dirname(require.resolve("@polywrap/workflow-manifest-schemas"));
