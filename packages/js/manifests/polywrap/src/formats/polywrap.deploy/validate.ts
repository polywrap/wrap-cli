...
import DeployManifestSchema_0_3_0 from "@polywrap/polywrap-manifest-schemas/formats/polywrap.deploy/0.3.0.json";
import DeployManifestSchema_0_4_0 from "@polywrap/polywrap-manifest-schemas/formats/polywrap.deploy/0.4.0.json";
...
const schemas: DeployManifestSchemas = {
  ...
  "0.3.0": DeployManifestSchema_0_3_0,
  "0.4.0": DeployManifestSchema_0_4_0,
};
