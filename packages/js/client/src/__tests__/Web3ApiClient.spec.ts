...
`);
  ...
  const runAsyncifyTest = async (api: {
    ensDomain: string,
    ipfsCid: string,
  }) => {
    const client = await getClient();
  ...
  const runSimpleStorageTest = async (api: {
    ensDomain: string,
    ipfsCid: string,
  }) => {
    const client = await getClient();
  ...
  const runObjectTypesTest = async (api: {
    ensDomain: string,
    ipfsCid: string,
  }) => {
    const ensUri = `ens/testnet/${api.ensDomain}`;
  ...
  const runBigIntTypeTest = async (api: {
    ensDomain: string,
    ipfsCid: string,
  }) => {
    const ensUri = `ens/testnet/${api.ensDomain}`;
  ...
  const runJsonTypeTest = async (api: {
    ensDomain: string,
    ipfsCid: string,
  }) => {
    type Json = string;
  ...
  const runBytesTypeTest = async (api: {
    ensDomain: string,
    ipfsCid: string,
  }) => {
    const ensUri = `ens/testnet/${api.ensDomain}`;
  ...
  const runEnumTypesTest = async (api: {
    ensDomain: string,
    ipfsCid: string,
  }) => {
    const ensUri = `ens/testnet/${api.ensDomain}`;
  ...
  const runLargeTypesTest = async (api: {
    ensDomain: string,
    ipfsCid: string,
  }) => {
    const ensUri = `ens/testnet/${api.ensDomain}`;
  ...
  const runNumberTypesTest = async (api: {
    ensDomain: string,
    ipfsCid: string,
  }) => {
    const ensUri = `ens/testnet/${api.ensDomain}`;
  ...
  const runInvalidTypesTest = async (api: {
    ensDomain: string,
    ipfsCid: string,
  }) => {
    const ensUri = `ens/testnet/${api.ensDomain}`;
  ...
  describe("wasm-as test cases", () => {
    ...
    it("simple-storage", async () => {
      ...
      await runSimpleStorageTest(api);
    });
