...
2
More
monorepo/packages/js/client/src/wasm/thread.ts /
@dOrgJelli
dOrgJelli all tests passing
Latest commit 104a971 15 days ago
 History
 1 contributor
We found potential security vulnerabilities in your dependencies.
You can see this message because you have been granted access to Dependabot alerts for this repository.

 327 lines (291 sloc)  8.64 KB
...
const imports = (memory: WebAssembly.Memory): W3Imports => ({
  w3: {
    __w3_subinvoke: WasmPromise.create(async (
      uriPtr: u32,
      uriLen: u32,
      modulePtr: u32,
      moduleLen: u32,
      ...
      state.subinvoke.result = result.data;
      state.subinvoke.error = result.error;
