...
var Encoder = /** @class */ (function () {
  function Encoder(options) {
    ...
    this.extensionCodec =
      (_a =
        options === null || options === void 0
          ? void 0
          : options.extensionCodec) !== null && _a !== void 0
        ? _a
        : ExtensionCodec.defaultCodec;
    this.context =
      options === null || options === void 0 ? void 0 : options.context; // needs a type assertion because EncoderOptions has no context property when ContextType is undefined
    this.useBigInt64 =
      (_b =
        options === null || options === void 0
          ? void 0
          : options.useBigInt64) !== null && _b !== void 0
        ? _b
        : false;
    this.maxDepth =
      (_c =
    ...
    this.initialBufferSize =
      (_d =
        options === null || options === void 0
          ? void 0
          : options.initialBufferSize) !== null && _d !== void 0
        ? _d
        : DEFAULT_INITIAL_BUFFER_SIZE;
    this.sortKeys =
      (_e =
        options === null || options === void 0 ? void 0 : options.sortKeys) !==
        null && _e !== void 0
        ? _e
        : false;
    this.forceFloat32 =
      (_f =
        options === null || options === void 0
          ? void 0
          : options.forceFloat32) !== null && _f !== void 0
        ? _f
        : false;
    this.ignoreUndefined =
      (_g =
        options === null || options === void 0
          ? void 0
          : options.ignoreUndefined) !== null && _g !== void 0
        ? _g
        : false;
    this.forceIntegerToFloat =
      (_h =
        options === null || options === void 0
          ? void 0
          : options.forceIntegerToFloat) !== null && _h !== void 0
        ? _h
        : false;
    this.pos = 0;
  ...
  Encoder.prototype.encodeObject = function (object, depth) {
    ...
    if (ext != null) {
      ...
      throw new Error(
        "Unrecognized object: ".concat(Object.prototype.toString.apply(object))
      );
    }
  };
...
var CachedKeyDecoder = /** @class */ (function () {
  ...
  CachedKeyDecoder.prototype.decode = function (
    bytes,
    inputOffset,
    byteLength
  ) {
...
var Decoder = /** @class */ (function () {
  function Decoder(options) {
    ...
    this.maxStrLength =
      (_c =
        options === null || options === void 0
          ? void 0
          : options.maxStrLength) !== null && _c !== void 0
        ? _c
        : UINT32_MAX;
    this.maxBinLength =
      (_d =
        options === null || options === void 0
          ? void 0
          : options.maxBinLength) !== null && _d !== void 0
        ? _d
        : UINT32_MAX;
    this.maxArrayLength =
      (_e =
        options === null || options === void 0
          ? void 0
          : options.maxArrayLength) !== null && _e !== void 0
        ? _e
        : UINT32_MAX;
    this.maxMapLength =
      (_f =
        options === null || options === void 0
          ? void 0
          : options.maxMapLength) !== null && _f !== void 0
        ? _f
        : UINT32_MAX;
    this.maxExtLength =
      (_g =
        options === null || options === void 0
          ? void 0
          : options.maxExtLength) !== null && _g !== void 0
        ? _g
        : UINT32_MAX;
    this.keyDecoder =
      (options === null || options === void 0 ? void 0 : options.keyDecoder) !==
      undefined
        ? options.keyDecoder
      ...
      return __generator$2(this, function (_f) {
        switch (_f.label) {
          ...
          case 12:
            ...
            (_e = this),
              (headByte = _e.headByte),
              (pos = _e.pos),
              (totalPos = _e.totalPos);
      ...
      return __generator$2(this, function (_e) {
        switch (_e.label) {
          ...
          case 1:
            ...
            _e.label = 2;
          case 2:
            return [4 /*yield*/, __await$1(stream_2.next())];
          case 3:
          ...
          case 16:
            ...
            if (!(!_a && !_b && (_c = stream_2.return)))
              return [3 /*break*/, 18];
            return [4 /*yield*/, __await$1(_c.call(stream_2))];
          case 17:
            _e.sent();
            _e.label = 18;
          case 18:
  ...
  Decoder.prototype.decodeUtf8String = function (byteLength, headerOffset) {
    ...
    if (
      this.stateIsMapKey() &&
      ((_a = this.keyDecoder) === null || _a === void 0
        ? void 0
        : _a.canBeCached(byteLength))
    ) {
...
function asyncIterableFromStream(stream) {
  return __asyncGenerator(
    this,
    arguments,
    function asyncIterableFromStream_1() {
