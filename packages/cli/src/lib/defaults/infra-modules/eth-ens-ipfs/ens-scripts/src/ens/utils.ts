...
interface ContractJson { abi: any, bytecode: string }
...
export async function deploy(provider: ethers.providers.JsonRpcProvider, { abi, bytecode }: ContractJson, ...args: any[]) {
